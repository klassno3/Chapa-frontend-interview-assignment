...
const Input = ({
  ...
  return (
    <div className="w-full z-20 flex flex-col items-start gap-2.5 group ">
      ...
      <div
        className={ `bg-white flex items-center justify-between w-full rounded-sm  font-sans focus:outline-none focus:ring-0  px-4 md:px-5 py-2
      ...
      >
        { type === "textarea" ?
          <textarea
            ...
            className={ `focus:outline-none bg-transparent  focus:ring-0 bg- placeholder:font-light placeholder:text-sm w-full text-sm ${disabled && "text-gray-400"
              }` }
          /> :
          <input
            inputMode={
            ...
            onBlur={ onBlur }
            placeholder={ placeHolder }
            className={ `focus:outline-none text-sm focus:ring-0 bg-transparent placeholder:font-light placeholder:text-sm w-full ${disabled && "text-gray-400"
              }` }
          />
